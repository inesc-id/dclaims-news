...
/* harmony export (immutable) */ __webpack_exports__["a"] = Sha256;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sha256_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js__);
...
function titles () {
  ...
  for (var item of list) {
    ...
    var encrypted = __WEBPACK_IMPORTED_MODULE_0__sha256_js__["a" /* default */].hash(strippedTitle)
...
function allElements () {
  ...
  var list = __WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js___default.a.getNewsItems(document)

  for (var i = 0; i < list.length; i++) {
    // var title = list[i].getElementsByClassName('homepage-news-title')[0].innerText
    var title = __WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js___default.a.getTitleElement(list[i])

    // var strippedTitle = title.replace(/\W/g, '').toLowerCase()
    var strippedTitle = __WEBPACK_IMPORTED_MODULE_1__hypercertsParser_js___default.a.cleanTitle(title)
    var articleId = __WEBPACK_IMPORTED_MODULE_0__sha256_js__["a" /* default */].hash(strippedTitle)
