...
describe('ArrayList', function () {
    ...
    describe('first(), last() and initial()', function () {
        it('should get first, last and initial elements', function () {
            ...
            expect(list.initial()).to.be.a(ArrayList);
    ...
    describe('rest()', function () {
        it('should return the rest of the list', function () {
            var list = new ArrayList;
            list.add([1, 2, 3, 4]);
            expect(list.rest()).to.be.a(ArrayList);
    ...
    describe('compact()', function () {
        it('should return a new list compacted', function () {
            ...
            expect(list.compact()).to.be.a(ArrayList);
    ...
    describe('flatten()', function () {
        it('should return a new list flatten', function () {
            var list = new ArrayList;
            list.add([[1, [2], [[3, [4, 5, [[6]]]]]]]);
            expect(list.flatten()).to.be.a(ArrayList);
    ...
    describe('without()', function () {
        it('should return a list without the specified values', function () {
            var list = new ArrayList;
            list.add([1, 2, 3, 4, 5, 6]);
            expect(list.without(1)).to.be.a(ArrayList);
    ...
    describe('find() and findOne()', function () {
        ...
        it('should find all the elements that match the query', function () {
            ...
            expect(evens).to.be.a(ArrayList);
