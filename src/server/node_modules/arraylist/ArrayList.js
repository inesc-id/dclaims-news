...
_.extend(ArrayList.prototype, {
  ...
  /**
   * Returns the list minus the lists specified, the difference is unique
   *
   * @returns {ArrayList}
   */
  difference: function () {
  ...
  /**
   * Merges together the values of each of the lists with the values at the corresponding position.
   *
   * @returns {ArrayList}
   */
  zip: function () {
  ...
  /**
   * Calls the method on each value in the list
   *
   * @param methodName
   * @returns {ArrayList}
   */
